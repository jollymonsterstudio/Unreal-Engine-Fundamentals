...
AUE4Fundamentals04Character::AUE4Fundamentals04Character()
{
...
void AUE4Fundamentals04Character::BeginPlay()
{
	Super::BeginPlay();
	...
	LeftFistCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals04Character::OnAttackHit);
	RightFistCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals04Character::OnAttackHit);
...
void AUE4Fundamentals04Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4Fundamentals04Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4Fundamentals04Character::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &AUE4Fundamentals04Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUE4Fundamentals04Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4Fundamentals04Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4Fundamentals04Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE4Fundamentals04Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Attack", IE_Pressed, this, &AUE4Fundamentals04Character::AttackInput);
	PlayerInputComponent->BindAction("Attack", IE_Released, this, &AUE4Fundamentals04Character::AttackEnd);
}

void AUE4Fundamentals04Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AUE4Fundamentals04Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AUE4Fundamentals04Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AUE4Fundamentals04Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals04Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals04Character::MoveForward(float Value)
{
...
void AUE4Fundamentals04Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
...
void AUE4Fundamentals04Character::AttackInput()
{
...
void AUE4Fundamentals04Character::AttackStart()
{
	Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals04Character::AttackEnd()
{
	Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals04Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AUE4Fundamentals04Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AUE4Fundamentals04Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
