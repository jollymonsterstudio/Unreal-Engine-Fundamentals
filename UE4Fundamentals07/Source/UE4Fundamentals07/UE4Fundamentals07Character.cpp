...
//////////////////////////////////////////////////////////////////////////
// AUE4Fundamentals07Character

AUE4Fundamentals07Character::AUE4Fundamentals07Character()
{
...
void AUE4Fundamentals07Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals07Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals07Character::OnAttackHit);
...
void AUE4Fundamentals07Character::Tick(float DeltaTime)
{
...
void AUE4Fundamentals07Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4Fundamentals07Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4Fundamentals07Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AUE4Fundamentals07Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUE4Fundamentals07Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4Fundamentals07Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4Fundamentals07Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE4Fundamentals07Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AUE4Fundamentals07Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AUE4Fundamentals07Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AUE4Fundamentals07Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AUE4Fundamentals07Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AUE4Fundamentals07Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AUE4Fundamentals07Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("FireTrace", IE_Pressed, this, &AUE4Fundamentals07Character::FireLineTrace);
	
}

void AUE4Fundamentals07Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AUE4Fundamentals07Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AUE4Fundamentals07Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AUE4Fundamentals07Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals07Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals07Character::MoveForward(float Value)
{
...
void AUE4Fundamentals07Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) && IsKeyboardEnabled )
	{
...
bool AUE4Fundamentals07Character::GetIsAnimationBlended()
{
	return IsAnimationBlended;
}

void AUE4Fundamentals07Character::SetIsKeyboardEnabled(bool Enabled)
{
	IsKeyboardEnabled = Enabled;
}

EAttackType AUE4Fundamentals07Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AUE4Fundamentals07Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AUE4Fundamentals07Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AUE4Fundamentals07Character::AttackInput(EAttackType AttackType)
{
...
void AUE4Fundamentals07Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals07Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals07Character::LightAttackStart()
{
	IsAttackLight = true;
}

void AUE4Fundamentals07Character::LightAttackEnd()
{
	IsAttackLight = false;
}

void AUE4Fundamentals07Character::StrongAttackStart()
{
	IsAttackStrong = true;
}

void AUE4Fundamentals07Character::StrongAttackEnd()
{
	IsAttackStrong = false;
}

void AUE4Fundamentals07Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AUE4Fundamentals07Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals07Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AUE4Fundamentals07Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
