...
//////////////////////////////////////////////////////////////////////////
// AUE4Fundamentals10Character

AUE4Fundamentals10Character::AUE4Fundamentals10Character()
{
...
void AUE4Fundamentals10Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals10Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals10Character::OnAttackHit);
...
void AUE4Fundamentals10Character::Tick(float DeltaTime)
{
...
void AUE4Fundamentals10Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4Fundamentals10Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4Fundamentals10Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AUE4Fundamentals10Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUE4Fundamentals10Character::LookUpAtRate);

	PlayerInputComponent->BindAction("ArmPlayer", IE_Pressed, this, &AUE4Fundamentals10Character::ArmPlayerImmediately);
	PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &AUE4Fundamentals10Character::CrouchStart);
	PlayerInputComponent->BindAction("Crouch", IE_Released, this, &AUE4Fundamentals10Character::CrouchEnd);

	PlayerInputComponent->BindAction("Run", IE_Pressed, this, &AUE4Fundamentals10Character::RunStart);
	PlayerInputComponent->BindAction("Run", IE_Released, this, &AUE4Fundamentals10Character::RunEnd);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4Fundamentals10Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4Fundamentals10Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE4Fundamentals10Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AUE4Fundamentals10Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AUE4Fundamentals10Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AUE4Fundamentals10Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AUE4Fundamentals10Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AUE4Fundamentals10Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AUE4Fundamentals10Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("Interact", IE_Pressed, this, &AUE4Fundamentals10Character::Interact);
	
}

void AUE4Fundamentals10Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AUE4Fundamentals10Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AUE4Fundamentals10Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AUE4Fundamentals10Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals10Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals10Character::MoveForward(float Value)
{
...
void AUE4Fundamentals10Character::MoveRight(float Value)
{
...
bool AUE4Fundamentals10Character::IsRunning()
{
	return bIsRunning;
}

float AUE4Fundamentals10Character::GetMoveRight()
{
	return MoveRightValue;
}

float AUE4Fundamentals10Character::GetMoveForward()
{
	return MoveForwardValue;
}

bool AUE4Fundamentals10Character::IsAnimationBlended()
{
	return bIsAnimationBlended;
}

bool AUE4Fundamentals10Character::IsArmed()
{
	return bIsArmed;
}

void AUE4Fundamentals10Character::SetIsKeyboardEnabled(bool Enabled)
{
	bIsKeyboardEnabled = Enabled;
}

EAttackType AUE4Fundamentals10Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AUE4Fundamentals10Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AUE4Fundamentals10Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AUE4Fundamentals10Character::AttackInput(EAttackType AttackType)
{
...
void AUE4Fundamentals10Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals10Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
	...
	//GetWorld()->GetTimerManager().SetTimer(ArmedToIdleTimerHandle, this, &AUE4Fundamentals10Character::TriggerCountdownToIdle, 1.f, true);
}

void AUE4Fundamentals10Character::LightAttackStart()
{
	bIsAttackLight = true;
}

void AUE4Fundamentals10Character::LightAttackEnd()
{
	bIsAttackLight = false;
}

void AUE4Fundamentals10Character::StrongAttackStart()
{
	bIsAttackStrong = true;
}

void AUE4Fundamentals10Character::StrongAttackEnd()
{
	bIsAttackStrong = false;
}

void AUE4Fundamentals10Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (InGameHUD)
	{
		...
		if (!GetWorld()->GetTimerManager().IsTimerActive(ComboResetTimerHandle)) {
			GetWorld()->GetTimerManager().SetTimer(ComboResetTimerHandle, this, &AUE4Fundamentals10Character::ResetCombo, 5.1f, true);
		}
		else {
...
void AUE4Fundamentals10Character::ResetCombo()
{
	CurrentCombo = 0;
	// update hud
	AInGameHUD* InGameHUD = Cast<AInGameHUD>(GetWorld()->GetFirstPlayerController()->GetHUD());
...
void AUE4Fundamentals10Character::TriggerCountdownToIdle()
{
...
void AUE4Fundamentals10Character::ArmPlayerImmediately()
{
	// flip flop the values
	ArmPlayer(!bIsArmed);
}

void AUE4Fundamentals10Character::ArmPlayer(bool Value)
{
	// flip / flop
	bIsArmed = Value;
...
void AUE4Fundamentals10Character::RunStart()
{
...
void AUE4Fundamentals10Character::RunEnd()
{
	if (!bIsCrouched && !bIsArmed)
	{
		bIsRunning = false;
...
void AUE4Fundamentals10Character::CrouchStart()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals10Character::CrouchEnd()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals10Character::Interact()
{
	FVector Start;
	FVector End;
...
void AUE4Fundamentals10Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals10Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AUE4Fundamentals10Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
