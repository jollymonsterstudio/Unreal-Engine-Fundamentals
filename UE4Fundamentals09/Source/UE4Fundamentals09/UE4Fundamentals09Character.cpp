...
//////////////////////////////////////////////////////////////////////////
// AUE4Fundamentals09Character

AUE4Fundamentals09Character::AUE4Fundamentals09Character()
{
...
void AUE4Fundamentals09Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals09Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals09Character::OnAttackHit);
...
void AUE4Fundamentals09Character::Tick(float DeltaTime)
{
...
void AUE4Fundamentals09Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4Fundamentals09Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4Fundamentals09Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AUE4Fundamentals09Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUE4Fundamentals09Character::LookUpAtRate);

	PlayerInputComponent->BindAction("ArmPlayer", IE_Pressed, this, &AUE4Fundamentals09Character::ArmPlayerImmediately);
	PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &AUE4Fundamentals09Character::CrouchStart);
	PlayerInputComponent->BindAction("Crouch", IE_Released, this, &AUE4Fundamentals09Character::CrouchEnd);

	PlayerInputComponent->BindAction("Run", IE_Pressed, this, &AUE4Fundamentals09Character::RunStart);
	PlayerInputComponent->BindAction("Run", IE_Released, this, &AUE4Fundamentals09Character::RunEnd);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4Fundamentals09Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4Fundamentals09Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE4Fundamentals09Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AUE4Fundamentals09Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AUE4Fundamentals09Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AUE4Fundamentals09Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AUE4Fundamentals09Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AUE4Fundamentals09Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AUE4Fundamentals09Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("Interact", IE_Pressed, this, &AUE4Fundamentals09Character::Interact);
	
}

void AUE4Fundamentals09Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AUE4Fundamentals09Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AUE4Fundamentals09Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AUE4Fundamentals09Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals09Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals09Character::MoveForward(float Value)
{
...
void AUE4Fundamentals09Character::MoveRight(float Value)
{
...
bool AUE4Fundamentals09Character::IsRunning()
{
	return bIsRunning;
}

float AUE4Fundamentals09Character::GetMoveRight()
{
	return MoveRightValue;
}

float AUE4Fundamentals09Character::GetMoveForward()
{
	return MoveForwardValue;
}

bool AUE4Fundamentals09Character::IsAnimationBlended()
{
	return bIsAnimationBlended;
}

bool AUE4Fundamentals09Character::IsArmed()
{
	return bIsArmed;
}

void AUE4Fundamentals09Character::SetIsKeyboardEnabled(bool Enabled)
{
	bIsKeyboardEnabled = Enabled;
}

EAttackType AUE4Fundamentals09Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AUE4Fundamentals09Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AUE4Fundamentals09Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AUE4Fundamentals09Character::AttackInput(EAttackType AttackType)
{
...
void AUE4Fundamentals09Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals09Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
	...
	//GetWorld()->GetTimerManager().SetTimer(ArmedToIdleTimerHandle, this, &AUE4Fundamentals09Character::TriggerCountdownToIdle, 1.f, true);
}

void AUE4Fundamentals09Character::LightAttackStart()
{
	bIsAttackLight = true;
}

void AUE4Fundamentals09Character::LightAttackEnd()
{
	bIsAttackLight = false;
}

void AUE4Fundamentals09Character::StrongAttackStart()
{
	bIsAttackStrong = true;
}

void AUE4Fundamentals09Character::StrongAttackEnd()
{
	bIsAttackStrong = false;
}

void AUE4Fundamentals09Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (InGameHUD)
	{
		...
		if (!GetWorld()->GetTimerManager().IsTimerActive(ComboResetTimerHandle)) {
			GetWorld()->GetTimerManager().SetTimer(ComboResetTimerHandle, this, &AUE4Fundamentals09Character::ResetCombo, 5.1f, true);
		}
		else {
...
void AUE4Fundamentals09Character::ResetCombo()
{
	CurrentCombo = 0;
	// update hud
	AInGameHUD* InGameHUD = Cast<AInGameHUD>(GetWorld()->GetFirstPlayerController()->GetHUD());
...
void AUE4Fundamentals09Character::TriggerCountdownToIdle()
{
...
void AUE4Fundamentals09Character::ArmPlayerImmediately()
{
	// flip flop the values
	ArmPlayer(!bIsArmed);
}

void AUE4Fundamentals09Character::ArmPlayer(bool Value)
{
	// flip / flop
	bIsArmed = Value;
...
void AUE4Fundamentals09Character::RunStart()
{
...
void AUE4Fundamentals09Character::RunEnd()
{
	if (!bIsCrouched && !bIsArmed)
	{
		bIsRunning = false;
...
void AUE4Fundamentals09Character::CrouchStart()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals09Character::CrouchEnd()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals09Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals09Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AUE4Fundamentals09Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
