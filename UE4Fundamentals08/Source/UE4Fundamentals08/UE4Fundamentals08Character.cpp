...
//////////////////////////////////////////////////////////////////////////
// AUE4Fundamentals08Character

AUE4Fundamentals08Character::AUE4Fundamentals08Character()
{
...
void AUE4Fundamentals08Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals08Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals08Character::OnAttackHit);
...
void AUE4Fundamentals08Character::Tick(float DeltaTime)
{
...
void AUE4Fundamentals08Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4Fundamentals08Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4Fundamentals08Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AUE4Fundamentals08Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUE4Fundamentals08Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4Fundamentals08Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4Fundamentals08Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE4Fundamentals08Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AUE4Fundamentals08Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AUE4Fundamentals08Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AUE4Fundamentals08Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AUE4Fundamentals08Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AUE4Fundamentals08Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AUE4Fundamentals08Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("FireTrace", IE_Pressed, this, &AUE4Fundamentals08Character::FireLineTrace);
	
}

void AUE4Fundamentals08Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AUE4Fundamentals08Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AUE4Fundamentals08Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AUE4Fundamentals08Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals08Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals08Character::MoveForward(float Value)
{
...
void AUE4Fundamentals08Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) && IsKeyboardEnabled )
	{
...
bool AUE4Fundamentals08Character::GetIsAnimationBlended()
{
	return IsAnimationBlended;
}

void AUE4Fundamentals08Character::SetIsKeyboardEnabled(bool Enabled)
{
	IsKeyboardEnabled = Enabled;
}

EAttackType AUE4Fundamentals08Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AUE4Fundamentals08Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AUE4Fundamentals08Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AUE4Fundamentals08Character::AttackInput(EAttackType AttackType)
{
...
void AUE4Fundamentals08Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals08Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals08Character::LightAttackStart()
{
	IsAttackLight = true;
}

void AUE4Fundamentals08Character::LightAttackEnd()
{
	IsAttackLight = false;
}

void AUE4Fundamentals08Character::StrongAttackStart()
{
	IsAttackStrong = true;
}

void AUE4Fundamentals08Character::StrongAttackEnd()
{
	IsAttackStrong = false;
}

void AUE4Fundamentals08Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (InGameHUD)
	{
		...
		if (!GetWorld()->GetTimerManager().IsTimerActive(ComboResetTimerHandle)) {
			GetWorld()->GetTimerManager().SetTimer(ComboResetTimerHandle, this, &AUE4Fundamentals08Character::ResetCombo, 5.1f, true);
		}
		else {
...
void AUE4Fundamentals08Character::ResetCombo()
{
	CurrentCombo = 0;
	// update hud
	AInGameHUD* InGameHUD = Cast<AInGameHUD>(GetWorld()->GetFirstPlayerController()->GetHUD());
...
void AUE4Fundamentals08Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals08Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AUE4Fundamentals08Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
