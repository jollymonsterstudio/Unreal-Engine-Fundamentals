...
//////////////////////////////////////////////////////////////////////////
// AUE4Fundamentals06Character

AUE4Fundamentals06Character::AUE4Fundamentals06Character()
{
...
void AUE4Fundamentals06Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals06Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals06Character::OnAttackHit);
...
void AUE4Fundamentals06Character::Tick(float DeltaTime)
{
...
void AUE4Fundamentals06Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4Fundamentals06Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4Fundamentals06Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AUE4Fundamentals06Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUE4Fundamentals06Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4Fundamentals06Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4Fundamentals06Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE4Fundamentals06Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AUE4Fundamentals06Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AUE4Fundamentals06Character::KickAttack);

	PlayerInputComponent->BindAction("FireTrace", IE_Pressed, this, &AUE4Fundamentals06Character::FireLineTrace);
	
}

void AUE4Fundamentals06Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AUE4Fundamentals06Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AUE4Fundamentals06Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AUE4Fundamentals06Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals06Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals06Character::MoveForward(float Value)
{
...
void AUE4Fundamentals06Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) && IsKeyboardEnabled )
	{
...
bool AUE4Fundamentals06Character::GetIsAnimationBlended()
{
	return IsAnimationBlended;
}

void AUE4Fundamentals06Character::SetIsKeyboardEnabled(bool Enabled)
{
	IsKeyboardEnabled = Enabled;
}

EAttackType AUE4Fundamentals06Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AUE4Fundamentals06Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AUE4Fundamentals06Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AUE4Fundamentals06Character::AttackInput(EAttackType AttackType)
{
...
void AUE4Fundamentals06Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals06Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals06Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AUE4Fundamentals06Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals06Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AUE4Fundamentals06Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
