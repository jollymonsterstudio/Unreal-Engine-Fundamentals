...
//////////////////////////////////////////////////////////////////////////
// AUE4Fundamentals12Character

AUE4Fundamentals12Character::AUE4Fundamentals12Character()
{
...
void AUE4Fundamentals12Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals12Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AUE4Fundamentals12Character::OnAttackHit);
...
void AUE4Fundamentals12Character::Tick(float DeltaTime)
{
...
void AUE4Fundamentals12Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4Fundamentals12Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4Fundamentals12Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AUE4Fundamentals12Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AUE4Fundamentals12Character::LookUpAtRate);

	PlayerInputComponent->BindAction("ArmPlayer", IE_Pressed, this, &AUE4Fundamentals12Character::ArmPlayerImmediately);
	PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &AUE4Fundamentals12Character::CrouchStart);
	PlayerInputComponent->BindAction("Crouch", IE_Released, this, &AUE4Fundamentals12Character::CrouchEnd);

	PlayerInputComponent->BindAction("Run", IE_Pressed, this, &AUE4Fundamentals12Character::RunStart);
	PlayerInputComponent->BindAction("Run", IE_Released, this, &AUE4Fundamentals12Character::RunEnd);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AUE4Fundamentals12Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AUE4Fundamentals12Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE4Fundamentals12Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AUE4Fundamentals12Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AUE4Fundamentals12Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AUE4Fundamentals12Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AUE4Fundamentals12Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AUE4Fundamentals12Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AUE4Fundamentals12Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("Interact", IE_Pressed, this, &AUE4Fundamentals12Character::Interact);
	
}

void AUE4Fundamentals12Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AUE4Fundamentals12Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AUE4Fundamentals12Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AUE4Fundamentals12Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals12Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AUE4Fundamentals12Character::MoveForward(float Value)
{
...
void AUE4Fundamentals12Character::MoveRight(float Value)
{
...
bool AUE4Fundamentals12Character::IsRunning()
{
	return bIsRunning;
}

float AUE4Fundamentals12Character::GetMoveRight()
{
	return MoveRightValue;
}

float AUE4Fundamentals12Character::GetMoveForward()
{
	return MoveForwardValue;
}

bool AUE4Fundamentals12Character::IsAnimationBlended()
{
	return bIsAnimationBlended;
}

bool AUE4Fundamentals12Character::IsArmed()
{
	return bIsArmed;
}

void AUE4Fundamentals12Character::SetIsKeyboardEnabled(bool Enabled)
{
	bIsKeyboardEnabled = Enabled;
}

EAttackType AUE4Fundamentals12Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AUE4Fundamentals12Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AUE4Fundamentals12Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AUE4Fundamentals12Character::AttackInput(EAttackType AttackType)
{
...
void AUE4Fundamentals12Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AUE4Fundamentals12Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
	...
	//GetWorld()->GetTimerManager().SetTimer(ArmedToIdleTimerHandle, this, &AUE4Fundamentals12Character::TriggerCountdownToIdle, 1.f, true);
}

void AUE4Fundamentals12Character::LightAttackStart()
{
	bIsAttackLight = true;
}

void AUE4Fundamentals12Character::LightAttackEnd()
{
	bIsAttackLight = false;
}

void AUE4Fundamentals12Character::StrongAttackStart()
{
	bIsAttackStrong = true;
}

void AUE4Fundamentals12Character::StrongAttackEnd()
{
	bIsAttackStrong = false;
}

void AUE4Fundamentals12Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (InGameHUD)
	{
		...
		if (!GetWorld()->GetTimerManager().IsTimerActive(ComboResetTimerHandle)) {
			GetWorld()->GetTimerManager().SetTimer(ComboResetTimerHandle, this, &AUE4Fundamentals12Character::ResetCombo, 5.1f, true);
		}
		else {
...
void AUE4Fundamentals12Character::ResetCombo()
{
	CurrentCombo = 0;
	// update hud
	AInGameHUD* InGameHUD = Cast<AInGameHUD>(GetWorld()->GetFirstPlayerController()->GetHUD());
...
void AUE4Fundamentals12Character::TriggerCountdownToIdle()
{
...
void AUE4Fundamentals12Character::ArmPlayerImmediately()
{
	// flip flop the values
	ArmPlayer(!bIsArmed);
}

void AUE4Fundamentals12Character::ArmPlayer(bool Value)
{
	// flip / flop
	bIsArmed = Value;
...
void AUE4Fundamentals12Character::RunStart()
{
...
void AUE4Fundamentals12Character::RunEnd()
{
	if (!bIsCrouched && !bIsArmed)
	{
		bIsRunning = false;
...
void AUE4Fundamentals12Character::CrouchStart()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals12Character::CrouchEnd()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals12Character::Interact()
{
	FVector Start;
	FVector End;
	...
	if(bIsHit && InteractHit.GetActor() != this)
	{
		...
		else if(InteractHit.GetActor()->IsA(ACharacter::StaticClass()))
		{
			...
			AUE4Fundamentals12Character* PossessableCharacter = Cast<AUE4Fundamentals12Character>(InteractHit.GetActor());
...
void AUE4Fundamentals12Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AUE4Fundamentals12Character::Log(ELogLevel CurrentLogLevel, FString Message)
{
	Log(CurrentLogLevel, Message, ELogOutput::ALL);
}

void AUE4Fundamentals12Character::Log(ELogLevel CurrentLogLevel, FString Message, ELogOutput LogOutput)
{
